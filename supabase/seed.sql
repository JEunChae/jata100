...
('rest',       '쉬다',       null, 'Vi', null),
('cough',      '기침하다',   null, 'Vi', null),
('sneeze',     '재채기하다', null, 'Vi', null),
('hesitate',   '망설이다',   null, 'Vi', null),
('rain',       '비가 오다',  null, 'Vi', null);

-- Pure Vt: 30 rows
insert into words (english, korean_vi, korean_vt, type, pair_id) values
('eat',   null, '~을 먹다',         'Vt', null),
('drink', null, '~을 마시다',       'Vt', null),
('see',   null, '~을 보다',         'Vt', null),
('hear',  null, '~을 듣다',         'Vt', null),
('buy',   null, '~을 사다',         'Vt', null),
('sell',  null, '~을 팔다',         'Vt', null),
('read',  null, '~을 읽다',         'Vt', null),
('write', null, '~을 쓰다',         'Vt', null),
('hit',   null, '~을 치다',         'Vt', null),
('catch', null, '~을 잡다',         'Vt', null),
('hold',  null, '~을 쥐다',         'Vt', null),
('wear',  null, '~을 입다',         'Vt', null),
('carry', null, '~을 들고 가다',    'Vt', null),
